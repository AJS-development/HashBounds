...
TreeBucket.prototype.getQuad=function(a){if(1>=this.QUAD_CACHE[0].length)return 0;var b=a.minX,c=a.minY,d=a.maxX,e=a.maxY,h=this.X,f=this.Y,k=this.MAX_X,g=this.MAX_Y,l=this.HALFX,m=this.HALFY;return e<=m?d<=l?1:b>=l?2:5:c>=m?d<=l?3:b>=l?4:6:d<=l?7:b>=l?8:a.width<this.BUCKET_SIZE||a.height<this.BUCKET_SIZE||b>h||d<k||c>f||e<g?0:-1};TreeBucket.prototype._every=function(a,b){return this.ITEM_LIST.every(function(c){return c._HashBoundsTempCheck!==b?(c._HashBoundsTempCheck=b,a(c)):!0})};
...
HashGrid.prototype.deleteBucket=function(a,b){var c=this.BUCKET_GRID[a];delete c[b];0===Object.keys(c).length&&delete this.BUCKET_GRID[a]};HashGrid.prototype.setBucket=function(a,b,c){var d=this.BUCKET_GRID[a];void 0===d&&(d={},this.BUCKET_GRID[a]=d);d[b]=c};HashGrid.prototype.getBucket=function(a,b){a=this.BUCKET_GRID[a];return void 0===a?void 0:a[b]};
HashGrid.prototype.createBucket=function(a,b){var c=new TreeBucket(a,b,this.BUCKETSIZE);this.setBucket(a,b,c);if(void 0!==this.NEXT_GRID){var d=Math.floor(a/2),e=Math.floor(b/2);a=2*(b-2*e)+a-2*d;b=this.NEXT_GRID.getBucket(d,e);void 0===b&&(b=this.NEXT_GRID.createBucket(d,e));c.PARENT=b;b.CHILDREN[a]=c;b.updateQuadCache()}return c};HashGrid.prototype.prune=function(){for(var a in this.BUCKET_GRID){var b=this.BUCKET_GRID[a],c;for(c in b){var d=b[c];0===d.COUNTER&&this.pruneBucket(d)}}};
HashGrid.prototype.pruneBucket=function(a){void 0!==a.PARENT&&(0===a.PARENT.COUNTER?this.NEXT_GRID.pruneBucket(a.PARENT):(a.PARENT.CHILDREN[a.BUCKET_X%2*2+a.BUCKET_Y%2]=void 0,a.PARENT.updateQuadCache()));a.COUNTER=-1;this.deleteBucket(a.BUCKET_X,a.BUCKET_Y)};
...
HashGrid.prototype.insert=function(a,b,c,d,e,h,f){var k=b.minX,g=b.minY,l=b.maxX;b=b.maxY;void 0===d&&(d=Math.floor(k*this.BUCKETSIZE_INV),e=Math.floor(g*this.BUCKETSIZE_INV),h=Math.floor(l*this.BUCKETSIZE_INV),f=Math.floor(b*this.BUCKETSIZE_INV));c.k1x=d;c.k1y=e;c.k2x=h;c.k2y=f;k=f-e+1;for(g=d;g<=h;++g)for(l=(g-d)*k-e,b=e;b<=f;++b){var m=this.getBucket(g,b);void 0===m&&(m=this.createBucket(g,b));m.set(a,c,l+b)}};
HashGrid.prototype.remove=function(a){for(var b=a.k1x,c=a.k1y,d=a.k2x,e=a.k2y,h=e-c+1,f=b;f<=d;++f)for(var k=(f-b)*h-c,g=c;g<=e;++g)this.getBucket(f,g).remove(a,k+g)};
HashGrid.prototype.every=function(a,b,c){if(void 0===a){for(var d in this.BUCKET_GRID){a=this.BUCKET_GRID[d];for(var e in a)if(!a[e].everyAll(b,c))return!1}return!0}d=Math.floor(a.minY*this.BUCKETSIZE_INV);e=Math.floor(a.maxX*this.BUCKETSIZE_INV);for(var h=Math.floor(a.maxY*this.BUCKETSIZE_INV),f=Math.floor(a.minX*this.BUCKETSIZE_INV);f<=e;++f)for(var k=d;k<=h;++k){var g=this.getBucket(f,k);if(void 0!==g&&!g.every(a,b,c))return!1}return!0};
var HashBounds=function(a,b,c,d){if(1>b)throw Error("Level count must be at least 1!");this.ID=void 0===d?HashBounds.LAST_ID++:d;this.MIN_SIZE=a;this.MIN_SIZE_INV=1/this.MIN_SIZE;this.LEVEL_COUNT=b;this.INITIAL_BOUNDS=c||{};HashBounds.convertBounds(this.INITIAL_BOUNDS);this.LEVELS=[];this.LOG2CACHE=this.BASE=void 0;this.QUERYID=0;this.setupLog2();this.init()};HashBounds.prototype.getQueryID=function(){4294967295<=this.QUERYID&&(this.QUERYID=-1,this.forEach(function(a){}));return this.QUERYID++};
...
HashBounds.prototype.toArray=function(a){void 0!==a&&HashBounds.convertBounds(a);var b=[];this.BASE.every(a,function(c){b.push(c);return!0},this.getQueryID());return b};HashBounds.prototype.every=function(a,b){void 0===b?(b=a,a=void 0):void 0!==a&&HashBounds.convertBounds(a);return this.BASE.every(a,b,this.getQueryID())};HashBounds.prototype.forEach=function(a,b){void 0===b?(b=a,a=void 0):void 0!==a&&HashBounds.convertBounds(a);this.BASE.every(a,function(c){b(c);return!0},this.getQueryID())};
HashBounds.prototype.boundsFitsInHash=function(a){HashBounds.convertBounds(a);return HashBounds.boundsContains(a,this.INITIAL_BOUNDS)};HashBounds.LAST_ID=0;HashBounds.mmToPS=function(a){a.x=a.minX;a.y=a.minY;a.width=a.maxX-a.minX;a.height=a.maxY-a.minY};HashBounds.psToMM=function(a){a.minX=a.x;a.minY=a.y;a.maxX=a.x+a.width;a.maxY=a.y+a.height};HashBounds.boundsOverlap=function(a,b){return!(a.minX>b.maxX||a.minY>b.maxY||a.maxX<b.minX||a.maxY<b.minY)};
HashBounds.boundsContains=function(a,b){return a.minX>=b.minX&&a.maxX<=b.maxX&&a.minY>=b.minY&&a.maxY<=b.maxY};
HashBounds.truncateBounds=function(a,b,c,d,e){if(1===a.TYPE)a.x=Math.max(a.x,b),a.y=Math.max(a.y,c),a.x+a.width>d&&(a.width=d-a.x),a.y+a.height>e&&(a.height=e-a.y);else if(2===a.TYPE)a.minX=Math.max(a.minX,b),a.minY=Math.max(a.minY,c),a.maxX=Math.min(a.maxX,d),a.maxY=Math.min(a.maxY,e);else throw Error("ERR: Bound not formatted! Please make sure bounds were put through the convertBounds function");};
HashBounds.convertBounds=function(a){if(void 0===a.TYPE)void 0!==a.x?(HashBounds.psToMM(a),a.TYPE=1):(HashBounds.mmToPS(a),a.TYPE=2);else if(1===a.TYPE)HashBounds.psToMM(a);else if(2===a.TYPE)HashBounds.mmToPS(a);else throw Error("Invalid bounds!");};
